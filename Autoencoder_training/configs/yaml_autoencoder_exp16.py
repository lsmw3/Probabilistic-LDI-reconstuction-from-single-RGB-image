...
# copied from exp15
# changed ldi to 5 channels
# changed perceptual_weight to -1.0
# changed trainset.num_of_ldi_channels to 5
# changed valset.num_of_ldi_channels to 5
# added disc_in_channels to lossconfig as 5

exp_name = "exp16_ldi_5"
